...
class AuthRule extends Common
{
    ...
    public function listBuilder($addonData = [], $params = [])
    {
        ...
        $batchToolBar = [
            Builder::button('Delete')->type('danger')->action('delete')->uri('/backend/rules/delete')->method('post'),
            Builder::button('Disable')->type('default')->action('batchDisable'),
        ];
        if (isset($params['trash']) && $params['trash'] === 'onlyTrashed') {
            $batchToolBar = [
                Builder::button('Delete Permanently')->type('danger')->action('deletePermanently')->uri('/backend/rules/delete')->method('post'),
        ...
        $tableColumn = [
            ...
            Builder::actions([
                ...
                Builder::button('Delete')->type('default')->action('delete')->uri('/backend/rules/delete')->method('post'),
            ])->title('Action'),
        ];
